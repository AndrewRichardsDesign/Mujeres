...
- `images/march/` — Numbered march photos (1-11) from "The March" folder
- `audio/` — Numbered audio testimonies (1-11, .m4a) from "The March" folder
...
- Cards 1-4, 7-9, 11 have photos + audio + AI-generated testimony summaries
- Cards 5, 6, 10 have audio + summaries only (no photos in Drive)
