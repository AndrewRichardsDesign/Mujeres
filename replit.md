...
- `images/march/` — March photos: before-1.jpg, before-2.jpg (Before tab), 1-9.jpg (During tab)
- `audio/` — March audio: before-1.m4a, before-2.m4a (Before tab), 1-9.m4a + 3.1.m4a (During tab)
- `videos/` — March videos: 9-2.mp4, 9-3.mp4 (During tab card 9 carousel)
- `CNAME` — Custom domain: www.voces8m.com

## The March — Before Tab

2 cards moved from During tab:
- Card 1: Majo & Mafer (before-1.jpg, before-1.m4a)
- Card 2: Helen & Caridad (before-2.jpg, before-2.m4a)
- Translation keys: march.before.desc1/2, march.before.testimony1/2

## The March — During Tab

9 cards with real content from the March 8, 2026 event in Mexico City:
- Cards 1-9: Jannai, Collectivo Gordofobia, Angeles(2 audios), Valeria, Brenda, Kim&Carolina, Monserrat, Esotérica, Denunciar a su violador
- All cards have photos + audio + AI-generated testimony summaries
- Card 3 (Angeles) has two inline audio players side by side (3.m4a + 3.1.m4a)
- Card 9 has a media carousel with 1 photo + 2 videos, navigable via arrow buttons and dots
